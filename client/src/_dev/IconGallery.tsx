...
const categories: { title: string; description: string; names: IconName[] }[] =
	[
		...
		},
		{
			title: "Interface",
			description:
				"Icônes d'interface génériques (src/assets/icons/interface/).",
			names: [
				"angleSmallDown",
				"angleSmallLeft",
				"angleSmallRight",
		...
		<div className="min-h-screen bg-base-200 px-6 py-10 text-primary md:px-12">
			<div className="relative mx-auto max-w-5xl">
				...
				<h1 className="mt-1 text-2xl font-black">
					Icônes de assets/icons
				</h1>
				<p className="mt-3 max-w-2xl text-sm text-primary/60">
					{total} icônes disponibles via{" "}
					<span className="font-mono">{'<Icon name="..." />'}</span>,
					groupées par sous-dossier de{" "}
					<span className="font-mono">src/assets/icons/</span>.
				</p>
