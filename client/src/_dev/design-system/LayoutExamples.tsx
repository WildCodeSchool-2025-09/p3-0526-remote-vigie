		...
		<div className="space-y-6">
			<div className="rounded-xl border border-dashed border-primary/15 bg-base-200 p-4 text-sm leading-relaxed text-primary/70">
				...
				<p className="mt-1">
					...
					(bg-base-100) →{" "}
					<span className="font-semibold text-primary">frames</span>{" "}
					(encarts bg-base-300, insérés du bord de{" "}
					<span className="font-mono">px-4</span>, espacés de{" "}
					<span className="font-mono">space-y-4</span>, le premier
					remonte de <span className="font-mono">-mt-8</span> sur le
					header) →{" "}
					<span className="font-semibold text-primary">header</span>{" "}
					(plein cadre, porte une couleur de fond ; l'image passe
					par-dessus en{" "}
