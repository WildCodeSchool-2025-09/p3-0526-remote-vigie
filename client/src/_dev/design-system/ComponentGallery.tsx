...
const families: Family[] = [
	...
	},
	{
		...
		title: "Map",
		description:
			"Carte Leaflet et marqueurs d'incidents avec vos icônes SVG.",
		...
		<div className="min-h-screen bg-base-200 px-4 py-10 text-primary md:px-12">
			<div className="relative mx-auto max-w-5xl">
				...
				<p className="mt-3 max-w-2xl text-sm text-primary/60">
					Composants UI assemblés à partir de Tailwind et daisyUI,
					stylés pour Vigie. Chaque exemple montre le rendu live et sa
					source TSX à copier.
				</p>
