		...
		<div className="min-h-screen bg-base-200 px-6 py-10 text-primary md:px-12">
			<div className="relative mx-auto max-w-5xl">
				...
				<h1 className="mt-1 text-2xl font-black">
					Couleurs de theme.css
				</h1>
				<p className="mt-3 max-w-2xl text-sm text-primary/60">
					Chaque pastille rend{" "}
					<span className="font-mono">var(--x)</span> : elle reflète
					le thème en direct. Le hex indiqué est la valeur littérale
					du fichier au moment de l'écriture.
				</p>
