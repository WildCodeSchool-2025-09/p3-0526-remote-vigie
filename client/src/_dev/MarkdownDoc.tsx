...
const components: Components = {
	...
	h3: ({ children }) => (
		<h3 className="mt-6 mb-1 text-base font-bold text-primary">
			{children}
		</h3>
	),
	p: ({ children }) => (
		<p className="my-3 text-sm leading-relaxed text-primary/80">
			{children}
		</p>
	),
	a: ({ children, href }) => (
	...
	return (
		<div className="min-h-screen bg-base-200 px-6 py-10 text-primary md:px-12">
			<div className="relative mx-auto max-w-3xl">
				...
				<BackButton />
				<p className="mt-3 font-mono text-xs text-primary/40">
					{label}
				</p>
