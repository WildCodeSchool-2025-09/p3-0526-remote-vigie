...
const incidentStyleByType = {
  ...
  insect:
    "bg-[var(--bg-insect)] text-[var(--insect)] border-2 border-[var(--insect)]",
  flood:
    "bg-[var(--bg-flood)] text-[var(--flood)] border-2 border-[var(--flood)]",
  hail: "bg-[var(--bg-hail)] text-[var(--hail)] border-2 border-[var(--hail)]",
  glaze:
    "bg-[var(--bg-glaze)] text-[var(--glaze)] border-2 border-[var(--glaze)]",
  snow: "bg-[var(--bg-snow)] text-[var(--snow)] border-2 border-[var(--snow)]",
  storm:
    "bg-[var(--bg-storm)] text-[var(--storm)] border-2 border-[var(--storm)]",
  ...
  animal:
    "bg-[var(--bg-animal)] text-[var(--animal)] border-2 border-[var(--animal)]",
...
function NotificationItem({
  ...
  const iconName =
    notification.type === "incident" || notification.type === "incident_resolved"
      ? (incidentIconByType[
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 grow">
        ...
        <p className="mt-1 truncate text-left text-sm text-secondary/60">{meta}</p>
      </div>
      <Icon
